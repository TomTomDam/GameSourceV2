...
namespace GameSource.Infrastructure.Migrations
{
    ...
    [Migration("20210401115314_ManyGamesToManyPlatformsRelationship")]
    partial class ManyGamesToManyPlatformsRelationship
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GamePlatform", b =>
                {
                    b.HasOne("GameSource.Models.GameSource.Game", null)
                        .WithMany()
                        .HasForeignKey("GamesID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GameSource.Models.GameSource.Platform", null)
                        .WithMany()
